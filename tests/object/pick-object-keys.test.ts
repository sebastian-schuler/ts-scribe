...
import { pickObjectKeys } from '../../src/object/index.js';

describe('pickObjectKeys', () => {
	it('should pick a single key from the object', () => {
		const object = { a: 1, b: 2, c: 3 };
		const result = pickObjectKeys(object, ['a']);
	...
	it('should pick multiple keys from the object', () => {
		...
		const result = pickObjectKeys(object, ['a', 'c']);
	...
	it('should return an empty object if no keys are specified', () => {
		const object = { a: 1, b: 2, c: 3 };
		const result = pickObjectKeys(object, []);
	...
	it('should return an empty object if the key to pick does not exist', () => {
		...
		// @ts-expect-error testing edge case
		const result = pickObjectKeys(object, ['c']); // 'c' doesn't exist in the object
	...
	it('should pick only existing keys from mixed valid and invalid keys', () => {
		...
		const result = pickObjectKeys(object, ['a', 'd', 'c']);
	...
	it('should handle objects with various value types', () => {
		...
		const result = pickObjectKeys(object, ['str', 'num', 'arr']);
	...
	it('should handle objects with symbol keys', () => {
		...
		const result = pickObjectKeys(object, [sym1, 'regular'] as const);
	...
	it('should preserve undefined values in picked keys', () => {
		...
		const result = pickObjectKeys(object, ['a', 'b']);
	...
	it('should handle duplicate keys in the keys array', () => {
		const object = { a: 1, b: 2, c: 3 };
		const result = pickObjectKeys(object, ['a', 'a', 'b']);
	...
	it('should only pick own and inherited properties', () => {
		...
		const result = pickObjectKeys(object, ['own', 'inherited']);
	...
	it('should handle non-enumerable properties', () => {
		...
		// @ts-expect-error testing edge case
		const result = pickObjectKeys(object, ['a', 'hidden']);
	...
	it('should work with arrays', () => {
		const array = ['a', 'b', 'c'];
		const result = pickObjectKeys(array, [0, 2] as const);
	...
	it('should create a new object reference', () => {
		const object = { a: 1, b: 2, c: 3 };
		const result = pickObjectKeys(object, ['a', 'b', 'c']);
